...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>Choix groupe pour soutenance</title>
      ...
      <div class="main">
        <form method="POST" style="margin: 30px;">
            <select name = "id_groupe" style="margin-bottom: 10px;">
                <?php
                    $sql = "SELECT DISTINCT etudiant.id_groupe FROM etudiant,eval_sout WHERE eval_sout.id_eval = :user and eval_sout.id_groupe = etudiant.id_groupe and etudiant.id_groupe IS NOT NULL";
                    $req = $bdd->prepare($sql);
