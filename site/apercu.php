...
<header>
 <h1> Voici les notes du groupe n°<?php echo $_SESSION['id_groupe']  ?></h1>
    ...
    foreach ($sql as $row) {
        ...
        $test2=$row['note_tut_comp'];
		$test3=$row['pourcent_travail'];
        $testt=$row['id_groupe'];
        echo"<tr>";
        ...
        echo"<td align='center'>". "<input type='text' size=7 (name='pourcent_trav'.$i) value=$test3>" ."</td>";
  ...
  ?>
<footer> 
	<a href='choixtuteur.php'><button type="button" class="btn btn-dark" href="index.html"> Changer de groupe </button></a>
